...
| 프로젝트 | 설명 |
|----------|------|
| [ttutak](https://github.com/rnqhstmd/ttutak) | DDD 기반 Claude Code 개발 자동화 플러그인. "개발해줘" 한마디면 PRD, 설계, 구현, 리뷰, 테스트, PR까지 뚝딱 |
| [tddak](https://github.com/rnqhstmd/tddak) | TDD 강제 Claude Code 개발 자동화 플러그인. PRD, 설계, RED·GREEN·REFACTOR, 리뷰, 검증까지 테스트 먼저 |
